...
export function TaskList({ tasks, onTitleChange, onStatusChange, onDescriptionChange, onPriorityChange, onDateUpdate, onDelete, onAlphaChange, onDateChange, onClick }: TaskListProps) {
